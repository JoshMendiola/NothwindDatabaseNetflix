...
SELECT COUNT(DISTINCT category) as ProductCategories FROM products;
...
SELECT first_name,last_name,phone FROM customers WHERE phone LIKE '1-(202)%' ORDER BY last_name,first_name ASC;
